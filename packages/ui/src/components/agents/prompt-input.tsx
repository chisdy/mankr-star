      ...
      <div className="mt-1 flex min-h-8 items-center gap-1">
        {actions.length ? (
          <Popover open={actionsOpen} onOpenChange={setActionsOpen}>
            <PopoverTrigger
              ...
              aria-label={labels?.actionsTrigger ?? "Add to prompt"}
              render={
                <Button
                  type="button"
                  variant="ghost"
        ...
        {models.length ? (
          ...
          >
            <SelectTrigger
              size="sm"
              className="h-8 w-auto max-w-52 rounded-xl border-0 bg-transparent px-2 py-0 text-xs shadow-none hover:bg-muted dark:bg-transparent"
            >
        ...
        <Button
          ...
          aria-label={
            loading
              ? (labels?.stop ?? "Stop generating")
              : (labels?.send ?? "Send prompt")
          }
