...
INSERT INTO bookmarks (
  id, source_type, canonical_url, external_id, owner, title, description, language,
...
('c1000000-0000-4000-8000-000000000001', 'github', 'https://github.com/facebook/react', 'facebook/react', 'facebook',
 ...
 datetime('now'), datetime('now')),
('c1000000-0000-4000-8000-000000000002', 'github', 'https://github.com/vercel/next.js', 'vercel/next.js', 'vercel',
 ...
 datetime('now'), datetime('now')),
('c1000000-0000-4000-8000-000000000003', 'github', 'https://github.com/shadcn-ui/ui', 'shadcn-ui/ui', 'shadcn-ui',
 ...
 datetime('now'), datetime('now')),
('c1000000-0000-4000-8000-000000000004', 'github', 'https://github.com/pmndrs/zustand', 'pmndrs/zustand', 'pmndrs',
 ...
 datetime('now'), datetime('now')),
('c1000000-0000-4000-8000-000000000005', 'github', 'https://github.com/anthropics/skills', 'anthropics/skills', 'anthropics',
 ...
 datetime('now'), datetime('now')),
('c1000000-0000-4000-8000-000000000006', 'github', 'https://github.com/langchain-ai/langchainjs', 'langchain-ai/langchainjs', 'langchain-ai',
 ...
 datetime('now'), datetime('now')),
('c1000000-0000-4000-8000-000000000007', 'github', 'https://github.com/drizzle-team/drizzle-orm', 'drizzle-team/drizzle-orm', 'drizzle-team',
 ...
 datetime('now'), datetime('now')),
('c1000000-0000-4000-8000-000000000008', 'github', 'https://github.com/honojs/hono', 'honojs/hono', 'honojs',
